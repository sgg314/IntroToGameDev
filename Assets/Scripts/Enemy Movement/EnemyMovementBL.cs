...
public class EnemyMovementBL : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyStartX = -2;//enemyScript.enemySpawnX;			//Makes enemies start at the coordinates of the tower they are spawned at
