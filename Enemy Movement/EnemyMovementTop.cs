...
public class EnemyMovementTop : MonoBehaviour
{
    ...
    public int spawnID;                 //Basically like a serial number registering each spawned enemy.
    ...
    void Start()
    {
        ...
        directionToTower = new Vector2(5, 0) - new Vector2(this.gameObject.transform.position.x, this.gameObject.transform.position.y);     //This line tells the enemies to move toward (5,0), where the tower is
